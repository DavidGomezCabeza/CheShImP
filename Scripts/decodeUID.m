function UID_details = decodeUID(UID_string)

validateattributes(UID_string, {'cell','char','string'}, {'nonempty','scalartext'})

UID_string = matlab.images.internal.stringToChar(UID_string);
...
case '1.2.840.10008.5.1.4.1.1.4.1'
    UID_details.Name = 'Enhanced MR Image Storage';
    UID_details.Type = 'SOP Class';
    
case '1.2.840.10008.5.1.4.1.1.4.2'
    UID_details.Name = 'MR Spectroscopy Storage';
    UID_details.Type = 'SOP Class';

case '1.2.840.10008.5.1.4.1.1.4.3'
    UID_details.Name = 'Enhanced MR Color Image';
    UID_details.Type = 'SOP Class';
...
case '1.2.840.10008.5.1.4.1.1.7.1' 
    UID_details.Name = 'Multi-frame Single Bit Secondary Capture Image Storage';
    UID_details.Type = 'SOP Class';
    
case '1.2.840.10008.5.1.4.1.1.7.2' 
    UID_details.Name = 'Multi-frame Grayscale Byte Secondary Capture Image Storage';
    UID_details.Type = 'SOP Class';
    
case '1.2.840.10008.5.1.4.1.1.7.3' 
    UID_details.Name = 'Multi-frame Grayscale Word Secondary Capture Image Storage';
    UID_details.Type = 'SOP Class';
    
case '1.2.840.10008.5.1.4.1.1.7.4' 
    UID_details.Name = 'Multi-frame True Color Secondary Capture Image Storage';
    UID_details.Type = 'SOP Class';
...
case '1.2.840.10008.1.2' 
    ...
    UID_details.Compressed = false;
    UID_details.Endian = 'ieee-le';
    UID_details.PixelEndian = 'ieee-le';
    UID_details.VR = 'Implicit';
    UID_details.LossyCompression = false;
    UID_details.CompressionType = '';
...
case '1.2.840.10008.1.2.4.50' 
    ...
    UID_details.Type = 'Transfer Syntax';
    UID_details.Compressed = true;
    UID_details.Endian = 'ieee-le';
    UID_details.PixelEndian = 'ieee-le';
    UID_details.VR = 'Explicit';
    UID_details.LossyCompression = true;
    UID_details.CompressionType = 'ISO_10918_1';
...
case '1.2.840.10008.1.2.4.81'
    ...
    UID_details.VR = 'Explicit';
    UID_details.LossyCompression = true;
    UID_details.CompressionType = 'ISO_14495_1';
...
case '1.2.840.10008.1.2.4.90'
    UID_details.Name = 'JPEG 2000 Image Compression (Lossless Only)';
    UID_details.Type = 'Transfer Syntax';
    UID_details.Compressed = true;
    UID_details.Endian = 'ieee-le';
    UID_details.PixelEndian = 'ieee-le';
...
case '1.2.840.10008.1.2.4.91'
    UID_details.Name = 'JPEG 2000 Image Compression';
    UID_details.Type = 'Transfer Syntax';
    UID_details.Compressed = true;
    UID_details.Endian = 'ieee-le';
    UID_details.PixelEndian = 'ieee-le';
    UID_details.VR = 'Explicit';
    UID_details.LossyCompression = true;
    UID_details.CompressionType = 'ISO_15444_1';

case '1.2.840.10008.1.2.4.92'
    UID_details.Name = 'JPEG 2000 Part 2 Multi-component Image Compression (Lossless Only)';
    UID_details.Type = 'Transfer Syntax';
    UID_details.Compressed = true;
    UID_details.Endian = 'ieee-le';
    UID_details.PixelEndian = 'ieee-le';
...
case '1.2.840.10008.1.2.4.93'
    UID_details.Name = 'JPEG 2000 Part 2 Multi-component Image Compression';
    UID_details.Type = 'Transfer Syntax';
    UID_details.Compressed = true;
    UID_details.Endian = 'ieee-le';
    UID_details.PixelEndian = 'ieee-le';
...
case '1.3.46.670589.33.1.4.1'
    UID_details.Name = 'Philips Explicit VR Little Endian (RLE)';
    UID_details.Type = 'Transfer Syntax';
    UID_details.Compressed = true;
    UID_details.Endian = 'ieee-le';
    UID_details.PixelEndian = 'ieee-le';
