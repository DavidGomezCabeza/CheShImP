...
%         [VisuCoreData]=bruker_write2dseq( [exportVisu.imagewrite_path, filesep, '2dseq'], obj.exportVisu, obj.data );
        ...
        [VisuCoreData]=bruker_write2dseq( [join([pwd(), "\pvmatlab\", exportVisu.imagewrite_path],''), filesep, '2dseq'], obj.exportVisu, obj.data );
...
%         bruker_writeVisu( exportVisu.imagewrite_path, exportVisu);
        bruker_writeVisu( join([pwd(), "\pvmatlab\", exportVisu.imagewrite_path],''), exportVisu);
    end
    ...
    function viewer(obj, varargin)
       ...
       brViewer(obj.data, 'Visu', obj.Visu, 'figuretitle', figuretitle, varargin{:});          
    end
