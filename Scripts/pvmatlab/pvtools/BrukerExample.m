...
% pathTestData = fullfile('E:\IBEC\NAFLD_PostDoc\2023_04_21_MatlabMRIDataProcessing\pvmatlab\pvtools\TestData\2');

pathTestData = fullfile('E:\IBEC\NAFLD_PostDoc\2023_04_21_MatlabMRIDataProcessing\UCSFtest_nonprocessed');

pathTestData2 = fullfile('E:\IBEC\NAFLD_PostDoc\2023_04_21_MatlabMRIDataProcessing\VoxelsPossitionTests\20230426_170750_CSIVoxelTests_2_CSIVoxelTests_2_1_1\9');

pathTestData = fullfile('C:\IBECPostDocDrive\2023_04_21_MatlabMRIDataProcessing\20230511_174703_Falcon_water_ethanol_Falcon_1HCSI_test_reconstruction_1_1\9');

pathTestData = fullfile('C:\IBECPostDocDrive\2023_04_21_MatlabMRIDataProcessing\20230525_114713_DGC_ProtonImagingResolutionTest3_DGC_ProtonImagingResolutionTest3_1_1\14');
...
% rawObj2 = RawDataObject(pathTestData2);
...
% Use bruker_getAcqSizes to get spatial raw data matrix size (equals 
% ACQ_size for pre-PV-360 datasets)
...
% Plot one line of raw data from middle slice. Note that all lines of 
% all frames are concatenated in the second dimension of the data field
h = figure;
dispFrame=floor(numSlices/2);
plot(real(rawObj.data{1}(1,:,dispFrame*numPhases+floor(numPhases/2)-1)),'-b'); hold on;
plot(imag(rawObj.data{1}(1,:,dispFrame*numPhases+floor(numPhases/2)-1)),'-r');
...
% 'all' = {'quadrature', 'phase_rotate', 'zero_filling', 'FT', 'phase_corr_pi', ...
...
imageObj=imageObj.genExportVisu('genmode','Template', ...
    'TemplatePath',[pathTestData, filesep, 'visu_pars']);
