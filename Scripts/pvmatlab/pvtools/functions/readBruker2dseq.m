...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if strcmp(imageType, 'auto') && ~isfield(Visu, 'VisuCoreFrameType')
        Visu.VisuCoreFrameType = 'REAL_IMAGE';
    end
    ...
    if FileID == -1
        error('Cannot open 2dseq file. Problem opening file %s.',path_to_2dseq);
    end
